...
module.exports = function(app){
     ...
     app.post("/ecomm/api/v1/catgories",[ requestValidator.validateCategoryRequest, authjwt.verifyToken, authjwt.isAdmin],categoryController.create)
     ...
     app.put("/ecomm/api/v1/categories/:id",[ requestValidator.validateCategoryRequest,authjwt.isAdmin], categoryController.update)
